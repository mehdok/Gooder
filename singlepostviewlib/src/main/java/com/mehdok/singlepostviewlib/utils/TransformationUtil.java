...
public final class TransformationUtil {
     ...
     * <p/>
     * Forked from {@link TransformationUtils#fitCenter(Bitmap, BitmapPool, int, int)}.
     *
     * @param sizeMultiplier The multiplier to apply to the {@code toTransform}'s dimensions.
     */
    private static Bitmap sizeMultiplier(BitmapPool pool, Bitmap toTransform,
    ...
    /**
     * A {@link com.bumptech.glide.load.Transformation} for transforming {@link Bitmap}'s size with
     * a multiplier.
     */
    ...
    /**
     * A {@link com.bumptech.glide.load.Transformation} for transforming {@link Bitmap}'s size not
     * to exceed the OpenGl texture size limit.
     */

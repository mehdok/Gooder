...
public class CommentViewFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_comment_view, container, false);

        // setup refresh action
        refreshLayout = (SwipeRefreshLayout) v.findViewById(R.id.comment_refresh_layout);
        ...
        // init recycler
        mRecyclerView = (InfiniteRecyclerView) v.findViewById(R.id.comment_item_recycler);
    ...
    protected void getData() {
        ...
        queryBuilder.setTypeFactor(
                MainActivityDelegate.getInstance().getActivity().getCommentKind());

        queryBuilder.setStart(mPosts.size());
        requestBuilder.getCommentedPosts(queryBuilder)
                ...
                .subscribe(new Observer<APIPosts>() {
                    ...
                    public void onCompleted() {
                        FireBaseHandler.sendLogEvent(MainActivityDelegate.getInstance()
                                ...
                                FireBaseHandler.ItemId.II_VIEW_COMMENTS,
                                FireBaseHandler.ItemName.IN_VIEW_COMMENTS);
                    }
